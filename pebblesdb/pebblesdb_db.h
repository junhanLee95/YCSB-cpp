...
//
#ifndef YCSB_C_PEBBLES_DB_H_
#define YCSB_C_PEBBLES_DB_H_
...
class PebblesdbDB : public DB {
 ...
 private:
  ...
  Status (PebblesdbDB::*method_scan_)(const std::string &, const std::string &,
  ...
  */
  struct xdb_ref* ref_ = nullptr;// change
  static int ref_cnt_;
  static std::mutex mu_;
};
